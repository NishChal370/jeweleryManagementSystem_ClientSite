import { AXIOS, URL_DELETE_BILL_BY_ID, URL_GET_ALL_RATES, URL_GET_BILLS_SUMMARY, URL_GET_BILL_BY_ID, URL_GET_ORDERS_SUMMARY, URL_GET_RATE_BY_DATE, URL_POST_BILL, URL_POST_ORDER, URL_POST_SAVED_BILL, URL_SET_RATE } from "./Constant"
...
export const Fetch_Orders_Summary = async(page)=>{
    console.log(URL_GET_ORDERS_SUMMARY)
    console.log("fje")
